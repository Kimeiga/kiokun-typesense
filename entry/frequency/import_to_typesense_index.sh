...
SCHEMA='{
  "name": "index",
  "fields": [
    { "name": "w", "type": "string", "infix": true},
    { "name": "f", "type": "int32", "sort": true},
    { "name": "i", "type": "int32", "sort": true}
  ]
}'
...
curl -X DELETE \
     ...
     "$TYPESENSE_HOST/collections/index"
...
curl -X POST \
     -H "X-TYPESENSE-API-KEY: $TYPESENSE_API_KEY" \
     --data-binary @index_key_search.jsonl \
     "$TYPESENSE_HOST/collections/index/documents/import"
